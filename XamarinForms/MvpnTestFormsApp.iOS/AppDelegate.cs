...
namespace MvpnTestFormsApp.iOS
{
    ...
    public class TestIosAppMamCoreSdkDelegate : CTXMAMCoreSdkDelegate
    {
        ...
        // This delegate method is used to let the app know when the linked SDKs have initialized and are ready for interaction with the application.
        // For example, you should wait for this event prior to trying to tunnel network traffic through the VPN when using the CTXMAMNetwork SDK.
        // Param - online. True if the user is currently online and able to fetch data from the CEM server. Otherwise false.
        public override void SdksInitializedAndReady(bool online)
        {
            if (online)
            {
                MessagingCenter.Send(Xamarin.Forms.Application.Current, "SdksInitializedAndReady");
            }
        }
    }
    #endregion
